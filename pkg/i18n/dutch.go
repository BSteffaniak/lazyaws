...
func dutchTranslationSet() TranslationSet {
	return TranslationSet{
		...
		IntroPopupMessage:                   "Bedankt voor het gebruik maken van lazyaws! 2 dingen die je moet weten:\n\n1) Als je meer van lazyaws zijn features wilt leren bekijk dan deze video:\n   https://youtu.be/CPLdltN7wgE\n\n2) Als je git gebruikt, ben je een programmeur! Met jouw hulp kunnen we lazyaws verbeteren, dus overweeg om een ​​donateur te worden en mee te doen aan het plezier op\n   https://github.com/BSteffaniak/lazyaws",
		...
		NoAutomaticGitFetchBody:             `Lazyaws kan niet "git fetch" uitvoeren in een privé repository, gebruik f in het branches paneel om "git fetch" manueel uit te voeren`,
		...
		PressEnterToReturn:                  "Press om terug te gaan naar lazyaws",
