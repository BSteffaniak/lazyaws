...
func polishTranslationSet() TranslationSet {
	return TranslationSet{
		...
		NoAutomaticGitFetchBody:             `Lazyaws nie może użyć "git fetch" w prywatnym repo, użyj f w panelu gałęzi żeby uruchomić "git fetch" ręcznie`,
		...
		PressEnterToReturn:                  "Wciśnij enter żeby wrócić do lazyaws",
