...
# 2) Create an integration test capturing the fact that it works (Don't commit it). See https://github.com/BSteffaniak/lazyaws/blob/master/pkg/integration/README.md
